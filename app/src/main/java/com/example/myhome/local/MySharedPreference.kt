...
class MySharedPreference2 @Inject constructor(
    ...
    fun isLoggedIn(): Boolean {
        return sharedPreferences?.getBoolean("isLoggedIn", false) == true
    }
    ...
    fun saveCurrentHouseId(houseId: String) {
        sharedPreferences?.edit { putString("currentHouseId", houseId)
        }
    }
    fun getCurrentHouseId(): String? {
        return sharedPreferences?.getString("currentHouseId", "home1")
    }
